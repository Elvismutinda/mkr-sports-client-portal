    ...
    <>
      <section id="matches" className="py-24 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-mkr-slate/50 border border-white/10 rounded-3xl p-8 hover:border-mkr-yellow transition-all duration-300 relative group overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <div className="text-4xl font-black text-white">04:51 PM</div>
              </div>
              <div className="bg-mkr-navy/80 px-4 py-2 rounded-xl border border-white/10 text-right">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-lg font-black text-mkr-yellow">2/14</span>
            ...
            <Button className="w-full">View Game Details</Button>
          </div>
        </div>
      </section>
